...
public class HelpCommandHandler implements CommandHandler {
    ...
    public void onCommand(String command, CommandSender sender, String... args) {
        ...
        sender.sendMessage("  &6restart &7<&2groupName&7 | &2baseName&7 | &2serverName&7 | &2proxyName&7> - &7restarts the given group, base, server, or proxy (If a base, stops/restarts every server on the base)");
